...
function NeuralNetworkD1FinanceOracle()
...
timeSeriesData = timeSeriesData(1:252,:);
...
for i=1:bound,
	...
	plot(avgDataToPlot,'linestyle','-','bo','markersize',5,'linewidth',1,'markerfacecolor','b');
